...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        case .phone:
            defaults.set(false, forKey: "iPad")
        case .pad:
            defaults.set(true, forKey: "iPad")
        default:
        ...
        if (!defaults.bool(forKey: "FirstLaunch")){
            ...
            defaults.set("*Seperate each parcel message by a comma 😀*", forKey: "ParcelList")
        }
        
        defaults.set(true, forKey: "DefaultMusic")
        defaults.set(false, forKey: "ParcelWithList")
